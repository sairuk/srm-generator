...
configs=[
    ...
    { 
        ...
        'exec': 'exo-open ', 
        'ini': '', 
        'scan_romdir': '/var/lib/freestation/dekstop', 
        'scan_artdir': '', 
        'data_dir': '', 
        'soft_lists': '', 
        'working_dir':'', 
    ...
    { 
        ...
        'format': 'mamesl', 
        'mode': 'file-parent', 
        'exec': '/usr/bin/flatpak run org.duckstation.DuckStation', 
        'ini': '~/.mame/mame.ini', 
        'scan_romdir': 'MAME_BASE_DIR_SOFT_DISK/SYSTEM_NAME', 
        'scan_artdir': 'MAME_BASE_DIR_SOFT_ART/SYSTEM_NAME', 
        'data_dir': 'MAME_BASE_DIR_HASH', 
        ...
        'mister_core': 'NONE', 
        'extension': 'chd', 
        'cmd': 'GAME_EXEC -batch -fullscreen -- "ROM_PATH"'
    },
    { 
    ...
    { 
        ...
        'exec': 'mame', 
        'ini': '~/.mame/mame.ini', 
        'scan_romdir': 'MAME_BASE_DIR_SOFT_ROMS/snes', 
        'scan_artdir': 'MAME_BASE_DIR_SOFT_ART/snes', 
        'data_dir': 'MAME_BASE_DIR_HASH', 
        'soft_lists': '', 
        'working_dir': 'system-working-dir', 
        'extensions': 'zip', 
        'mister_core': 'SNES', 
        'extension': 'zip', 
        'cmd': 'GAME_EXEC snespal ROM_BASENAME'
    },
    { 
        'title': 'SEGA 32X', 
